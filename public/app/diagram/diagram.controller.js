...
(function (diagram) {
            ...
            this.shapePropertiesChange = function (e) {
                ...
                for (i = 0; i < elements.length; i++) {
                    ...
                    if (element instanceof Shape) {
                        ...
                        shape.bounds(new Rectangle(_this.selectedShape.options.x, _this.selectedShape.options.y, _this.selectedShape.options.width, _this.selectedShape.options.height));
                    }
                }
            };
    ...
    angular.module('diagram').controller('diagram.DiagramController', DiagramController);
})(diagram || (diagram = {}));
